	...
	<div class="container-fluid he">
		<nav class="navbar navbar-inverse navbar-fixed-top">
			<div class="navbar-header">
				<a class="navbar-brand logo" style="font-size: 30px" href="#">HG
					STORE</a>
			</div>
		</nav>
	</div>
			...
			<div class="col-sm-10">
				<div class="col-sm-12">
					<div class="form-group" style="margin-top: 30px">
						<label class="control-label col-sm-1" for="address">Name product</label>
						<div class="col-sm-5">	<input type="text" class="form-control key-search"	name="keySearch"></div>
					</div>
				</div>
				<div class="col-sm-12">
					<button type="button" class="btn btn-primary"
						style="margin-left: 20%; margin-top: 20px; margin-right: 60px">Search</button>
					<button type="button" class="btn btn-primary"
						style="margin-top: 20px">Add Product</button>
				</div>

				<div class="col-sm-12 left-menu"></div>
